...
class starter {
	...
	public static boolean isLeapYear(int ye){
		if(ye % 4 == 0){
			return true;
		}
		else{
	...
	public static int getDigitSum(int num){
		int num1 = (int) ((num / Math.pow(10, 0)) % 10);
		int num2 = (int) ((num / Math.pow(10, 1)) % 10);
		int num3 = (int) ((num / Math.pow(10, 2)) % 10);
		int num4 = (int) ((num / Math.pow(10, 3)) % 10);
		int num5 = (int) ((num / Math.pow(10, 4)) % 10);
